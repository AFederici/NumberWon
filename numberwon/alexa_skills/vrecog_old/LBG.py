#speaker specific Vector Quantization codebook using LBG algorithm from https://ccrma.stanford.edu/~orchi/Documents/speaker_recognition_report.pdf
...
def lbg(features, M):
    ...
    # print 'final codebook', np.shape(codebook)
    return codebook
